...
The inclusionary idea was that these loops are also **programs of learning**: an Eco-Lab, where
...
At the centre of each is a **living machine**: the point where the neighbourhood's solid and
liquid waste, its food and its water arrive, are treated through a series of tanks, wetland
